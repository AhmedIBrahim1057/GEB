...
<div role="main" class="main full-height initial-height" id="main">    
    <section class="section section-title section-text-light section-background section-center" style="background-image: url({{asset('images/custom-header-bg.jpg')}});">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="font-weight-normal custom-font-size-2 m-none pb-sm">Meetings</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row" style="padding: 0px 30px ;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="studyCaseWrapper" onclick="location.href='#'">
                        ...
                        <div class="info">
                            <h3 style="margin-top: 20px">meeting title</h3>
                            <p style="margin-top: -10px">meeting host institution</p>
                            <p style="margin-top: -10px">meeting date</p>
                            {{-- @php
                                $rangeDate = $meeting->date;
